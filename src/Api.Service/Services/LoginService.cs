...
namespace Api.Service.Services
{
    public class LoginService : ILoginService
    {
        ...
        // IConfiguration serve para pegar os dados de appsettings.json em Api.Application
        ...
        public async Task<object> FindByLogin(LoginDto user)
        {
            ...
            //verifico se user não é nulo ou se não possui espaço em branco no campo email dentro do objeto user
